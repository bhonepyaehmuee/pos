...
<body class="animsition">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#userList') }}">
                                <i class="fa-solid fa-users-viewfinder"></i>User List</a>
                        </li>
                        <li>
                            <a href="{{ route('admin#contactList') }}">
                                <i class="fa-regular fa-address-book"></i>Contact Form List</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                        ...
                                        <div class="image">
                                            ...
                                            @else
                                                <img src="{{ asset('storage/' . Auth::user()->image) }}"
                                                    alt="{{ asset(Auth::user()->name) }}" class="img-thumbnail" />
                                            @endif
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form action="{{ route('logout') }}" method="post"
                                                    ...
                                                    @csrf
                                                    <button class=" btn btn-outline-primary text-center col-10 "
                                                        type="submit">
                                                        {{-- <i class="zmdi zmdi-power px-1"></i> --}}
    ...
    {{-- cdn jquesy link --}}
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.4/jquery.min.map">
