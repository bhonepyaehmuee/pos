                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h2 class="text-center title-2 row">
                                <a href="{{ route('admin#userList') }}" class="text-dark ms-3 fs-4  col-1 ">
                                    <i class="fa-solid fa-arrow-left"></i>
                                </a><span class="col-4 offset-3">Update Information</span>
                            </h2>
                            <hr>
                            @foreach ($useracc as $useracc)
                                <form action="{{ route('admin#UserUpdate', $useracc->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-4 offset-1 ">
                                            ...
                                            @if ($useracc->image == null)
                                                ...
                                                @endif
                                            @else
                                                <img src="{{ asset('storage/' . $useracc->image) }}" alt="">
                                            @endif
                                            ...
                                            <form action="" method="get">
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-pament" name="name" type="text"
                                                        ...
                                                        value="{{ old('name', $useracc->name) }}" aria-required="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-pament" name="email" type="email"
                                                        ...
                                                        value="{{ old('name', $useracc->email) }}" aria-required="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-pament" name="phone" type="text"
                                                        ...
                                                        value="{{ old('phone', $useracc->phone) }}" aria-required="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender" id=""
                                                        ...
                                                        <option value="male"
                                                            @if ($useracc->gender == 'male') selected @endif>Male</option>
                                                        <option value="female"
                                                            @if ($useracc->gender == 'female') selected @endif>Female
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" id="" class="form-control @error('address') is-invalid @enderror" cols="30"
                                                        rows="10" placeholder="Enter Admin Address...">{{ old('address', $useracc->address) }}</textarea>
                                                    @error('address')
                                                        <div class="invalid-feedback"> {{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-pament" name="role" type="text"
                                                        ...
                                                        value={{ old('role', $useracc->role) }} aria-required="true"
